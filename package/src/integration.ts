...
export const optionsSchema = z.object({
  ...
  name: z.string(),
  /**
   * The subtitle that should be displayed on the main page.
   */
  subtitle: z.string(),
  /**
   * The theme color of the site. Optional. Defaults to `#f48866`.
   */
  ...
  openGraph: z.object({
    ...
    /**
     * Open Graph meta tags for the challenges page.
     */
    challenges: openGraphOptionsSchema,
  }),
  /**
...
export default function integration(options: z.infer<typeof optionsSchema>): AstroIntegration {
  ...
  const validatedOptions = optionsSchema.parse(options);
    ...
    export const subtitle = ${JSON.stringify(validatedOptions.subtitle)};
    ...
    export const openGraph = {
      ...
      challenges: ${JSON.stringify(validatedOptions.openGraph.challenges)},
    };
